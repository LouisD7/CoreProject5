...
class TestGetPatientDetails(unittest.TestCase):
    @patch_boto(test_variables.TABLE_ITEM)
    def test_get_request_happy_path_returns_200(self):
        event = get_patient_details(json_file_parser("json\\get_request\\get_request.json"))
    ...
    def test_get_request_missing_patientID_returns_400(self):
        event = get_patient_details(json_file_parser("json\\get_request\\get_request_missing_patientID.json"))
        response = event.get_patient_data()
    ...
    def test_get_request_patientID_length_incorrect_returns_400(self):
        event = get_patient_details(json_file_parser("json\\get_request\\get_request_incorrect_patientID_length.json"))
        response = event.get_patient_data()
    ...
    def test_get_request_patientID_containes_non_numeric_characters_returns_400(self):
        event = get_patient_details(json_file_parser("json\\get_request\\get_request_patientID_conatins_non_numeric_characters.json"))
        response = event.get_patient_data()
